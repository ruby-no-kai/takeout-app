...
#tt = @target_time = Time.now + 20
tt = @target_time = Time.new(2021, 9, 10, 14,2,0)
...
@live_cm_size = 60 + 5
actions = actions_schedule_live('2021/edited/CM/platinum-cm-6.mp4')

#actions = actions_schedule_prerec('2021/edited/day2/aycabta.mp4', 26,8)
